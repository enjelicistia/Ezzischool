...
export default function PageKehadiranGuru() {
	...
	const handleExport = () => {
		...
		setTimeout(() => {
			...
			navigate("/dashboard/kehadiran/guru");
		}, 250);
	};
	...
	return (
		<div className="m-4 p-4 rounded-lg bg-white">
			<h1 className="font-bold text-2xl mb-4">Presensi Guru</h1>
						...
						<CardHeader>
							<CardTitle className="flex flex-col gap-4 xl:flex-row xl:justify-between xl:items-center">
								<div className="flex flex-col xl:flex-row gap-4 items-end">
									<div className="grid w-full items-center gap-1 lg:w-[220px]">
										<Label
											htmlFor="tanggal"
						...
						<Table>
							<TableHeader>
								<TableRow className="bg-utama/50 border border-textUtama">
									...
									<TableHead className="text-black font-bold text-sm text-center text-nowrap">NAMA GURU</TableHead>
							...
							<CardTitle className="flex flex-col gap-4 xl:flex-row xl:justify-between xl:items-center">
								...
								<AlertDialog>
									...
									<AlertDialogContent className="max-w-6xl p-0 overflow-hidden border-none">
										<AlertDialogHeader className="">
											<AlertDialogTitle className="flex justify-between bg-[#90CDF4] py-2 px-4">
												<p className="text-white font-semibold">Report Presensi Guru</p>
												<AlertDialogCancel className="p-0 size-6 border-none shadow-none bg-transparent">
													<X />
												</AlertDialogCancel>
											</AlertDialogTitle>
											<AlertDialogDescription asChild>
												<div className="text-black">
													<div className="grid grid-cols-1 xl:grid-cols-5 gap-4 px-4 py-6 bg-utama/10 items-end">
														<div className="grid w-full items-center gap-1">
															...
															<Popover>
																<PopoverTrigger asChild>
																	...
																	>
																		{dateMulai ? format(dateMulai, "PPP") : <span>Pilih tanggal mulai</span>}
																		<CalendarIcon className="mr-2 h-4 w-4" />
																	</Button>
																</PopoverTrigger>
																<PopoverContent className="p-0 w-full">
															...
															<Popover>
																<PopoverTrigger asChild>
																	<Button
																		...
																		className="justify-between text-left font-normal"
																	>
																		{dateAkhir ? format(dateAkhir, "PPP") : <span>Pilih tanggal akhir</span>}
																		<CalendarIcon className="mr-2 h-4 w-4" />
																	</Button>
																</PopoverTrigger>
																<PopoverContent className="p-0 w-full">
													...
													<div className="p-4 flex flex-col gap-4">
														<Table>
															<TableHeader>
																<TableRow className="bg-utama/50 border border-textUtama">
																	<TableHead className="w-[240px] text-black font-bold text-sm text-center text-nowrap">NAMA GURU</TableHead>
															...
															<TableBody>
																{[...Array(9)].map((_, index) => (
																	...
																	>
																		<TableCell className="text-center font-medium border-l border-textUtama text-black">Tabel</TableCell>
																		<TableCell className="text-center font-medium border-textUtama text-black">Tabel</TableCell>
																		<TableCell className="text-center font-medium border-textUtama text-black">Tabel</TableCell>
																		<TableCell className="text-center font-medium border-textUtama text-black">Tabel</TableCell>
																		<TableCell className="text-center font-medium border-textUtama text-black">Tabel</TableCell>
																		<TableCell className="text-center font-medium border-r border-textUtama text-black">Tabel</TableCell>
																	</TableRow>
																))}
															</TableBody>
															<TableFooter className="border border-textUtama">
							...
							<TableBody>
								{[...Array(9)].map((_, index) => (
									...
									>
										...
										<TableCell className="text-center border-textUtama">{(index + 1) % 6 || 4}</TableCell>
										<TableCell className="text-center border-textUtama text-nowrap">{index === 0 ? "Senin, 12-12-2024" : "Tabel"}</TableCell>
										<TableCell className="text-center border-textUtama">{index === 0 ? "00:00" : "Tabel"}</TableCell>
										<TableCell className="text-center border-textUtama">
											<AlertDialog>
												<AlertDialogTrigger asChild>
													<Button className={`w-full bg-utama hover:bg-utamaHover ${index === 0 ? "bg-utama hover:bg-utamaHover" : index === 1 ? "bg-[#F6E05E] hover:bg-yellow-500" : index === 2 ? "bg-red-500 hover:bg-red-600" : "bg-utama hover:bg-utamaHover"}`}>{index === 0 ? "Tepat Waktu" : index === 1 ? "Sakit" : index === 2 ? "Terlambat" : "Tepat Waktu"}</Button>
												</AlertDialogTrigger>
										...
										<TableCell className="text-center border-r border-textUtama text-nowrap">
											<ButtonDelete href="/dashboard/kehadiran/guru">
